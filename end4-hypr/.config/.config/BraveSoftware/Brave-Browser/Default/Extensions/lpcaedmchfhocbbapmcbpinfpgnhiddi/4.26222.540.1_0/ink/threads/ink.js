...
function assignWasmExports(wasmExports) {
  ...
  dynCall_i = dynCalls["i"] = wasmExports["Tg"];
  dynCall_iiidd = dynCalls["iiidd"] = wasmExports["Ug"];
  dynCall_iidd = dynCalls["iidd"] = wasmExports["Vg"];
  dynCall_ii = dynCalls["ii"] = wasmExports["Wg"];
  dynCall_vi = dynCalls["vi"] = wasmExports["Xg"];
  dynCall_iii = dynCalls["iii"] = wasmExports["Yg"];
  dynCall_vii = dynCalls["vii"] = wasmExports["Zg"];
  dynCall_iiiii = dynCalls["iiiii"] = wasmExports["_g"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["$g"];
  dynCall_viii = dynCalls["viii"] = wasmExports["ah"];
