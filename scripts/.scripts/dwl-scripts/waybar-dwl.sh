...
pango_tag_default="<span                      foreground='#a9b1d6'>" # Pango span style for 'default' tags (foreground_secondary)
pango_tag_active="<span overline='single' overline_color='#7aa2f7'>" # Pango span style for 'active' tags (primary_color)
pango_tag_selected="<span                     foreground='#bb9af7'>" # Pango span style for 'selected' tags (accent_color)
pango_tag_urgent="<span                       background='#f7768e'>" # Pango span style for 'urgent' tags (error_color)
pango_layout="<span                           foreground='#e0af68'>" # Pango span style for 'layout' character (warning_color)
pango_title="<span                            foreground='#7aa2f7'>" # Pango span style for 'title' monitor (primary_color)
pango_inactive="<span                         foreground='#565f89'>" # Pango span style for elements on an INACTIVE monitor (foreground_dim)
