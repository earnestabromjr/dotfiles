...
local iDIR = "local_var_HOME/.config/swaync/images/ja.png"
...
hl.config({
    listener = {
        timeout = 540,
        -- 9 min
        on-timeout = "notify-send -i local_var_HOME/.config/swaync/images/ja.png  You are idle!",
        -- command to run when timeout has passed
        on-resume = "notify-send -i local_var_HOME/.config/swaync/images/ja.png  Oh! you're Back  Hello !!!",
